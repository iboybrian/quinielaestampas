export const translations = {
  es: {
    ...
    quiniela: {
      ...
      groupsSubtitle: 'Grupos de Qatar 2022 (A–H) · Grupos I–L por definirse en 2026',
      create: 'Crear',
      ...
      copied: '¡Copiado!',
      copyInvitation: 'Copiar invitación completa',
      invitationCopied: '¡Invitación copiada!',
      invitationText: 'Únete a la quiniela {quinielaName} que ha creado {creatorName} para la Copa Mundial 2026. Únete con el código de acceso: {code}. También puedes ingresar desde tu dispositivo móvil o computadora con el siguiente link: {link}',
    ...
    admin: {
      ...
      nameLabel: 'Nombre de la quiniela',
      ...
      removing: 'Eliminando…',
      deleteZone: 'Zona de Peligro',
      deleteBtn: 'Eliminar Quiniela',
      deleteDesc: 'Elimina permanentemente esta quiniela y todos sus datos.',
      confirmDeleteTitle: '¿Eliminar quiniela?',
      deleteWarningMembers: 'Hay {n} participante(s) además de ti que perderán su historial.',
      deleteWarningPoints: 'Hay predicciones con puntos ya registrados.',
      deleteIrreversible: 'Esta acción es irreversible y no se puede deshacer.',
      deleting: 'Eliminando…',
      closeAtPhaseLabel: 'Fase de cierre',
      closeAtPhaseDesc: 'Define en qué fase se determina el ganador. Al terminar esa fase la quiniela queda cerrada.',
      closeAtPhaseOptions: {
        none:  'Completa (hasta la Final)',
        r16:   'Octavos de Final',
        qf:    'Cuartos de Final',
        sf:    'Semifinales',
        final: 'Final',
      },
      featureExtraPointsLabel: 'Puntos Extra',
      extraPointsDesc: 'Activa predicciones adicionales para partidos de Cuartos de Final en adelante: ¿quién anota primero? y ¿en qué tiempo? Cada predicción correcta suma +1 punto.',
      extraPointsOff: 'Sin cambios',
      extraPointsOffDesc: 'Sistema actual',
      extraPointsOn: 'Activar',
      extraPointsOnDesc: 'Con Puntos Extra',
      featureModalTitle: '¡Nuevas funciones para tu quiniela!',
      featureModalSubtitle: 'Puntos Extra y Fase de cierre',
      featureModalExtraPoints: 'en partidos de <b>Cuartos en adelante</b>, cada jugador podrá predecir quién marcará el primer gol y en qué parte del partido ocurrirá (primera o segunda mitad). Cada acierto suma <b>+1 punto</b> adicional.',
      featureModalClosePhase: 'elige en qué ronda se decide el ganador de la quiniela. Al terminar esa fase, los partidos siguientes quedan bloqueados y se anuncia al campeón.',
      featureModalBanner: 'Al cerrar la quiniela, el <b>ganador de la quiniela</b> aparece destacado con un banner en la tabla de posiciones para todos los participantes.',
      featureModalImportantLabel: 'Importante',
      featureModalImportantBody: 'Recomendamos avisarle a tus participantes antes de activar cualquier cambio, para que todos estén enterados.',
      featureModalHint: 'Recuerda presionar <b>Guardar cambios</b> al final de los ajustes para que la configuración se aplique correctamente.',
      featureModalLater: 'Después',
      featureModalGoSettings: 'Ir a Ajustes',
    },
    quiniela_winner: {
      closed: 'Quiniela Cerrada',
      champion: 'Campeón',
      closedPhase: {
        r16:   'Cerrada en Octavos',
        qf:    'Cerrada en Cuartos',
        sf:    'Cerrada en Semis',
        final: 'Cerrada en Final',
      },
      overlayTitle: '¡Quiniela Cerrada!',
    },
    profile: {
    ...
    marketplace: {
      ...
      special: '⭐ Especiales',
      searchTeam: 'Buscar selección o código…',
      noResults: 'Sin resultados',
      filters: { All: 'Todos', Have: 'Tengo', Needed: 'Busco', Missing: 'Faltan', Duplicate: 'Repetidas' },
  ...
  en: {
    ...
    home: {
      title1: 'WORLD CUP',
      title2: '2026 HUB',
      subtitle: 'Predict match scores, compete with friends in pools, and complete your ultimate sticker collection.',
      album: {
        title: 'Sticker Album',
      ...
      signUpCta: {
        ...
        desc: 'Sign up free to unlock prediction pools, save your sticker album, and connect with other collectors.',
        signUp: 'Sign Up',
    ...
    quiniela: {
      title: 'Prediction Pools',
      subtitle: 'Create or join prediction pools',
      groupTitle: 'Group {letter}',
      groupsSubtitle: 'WC 2022 groups (A–H) · Groups I–L set at 2026 draw',
      create: 'Create',
      createDesc: 'Start a new pool',
      join: 'Join',
      joinDesc: 'Enter a code',
      createTitle: '✏️ Create a Pool',
      joinTitle: '🔑 Join with Code',
      groupName: 'Pool name (e.g. Office FC 2026)',
      createBtn: 'Create Pool',
      joinBtn: 'Join Pool',
      enterCode: 'Enter 6-digit code',
      signInCreate: 'Sign in to create a pool',
      signInJoin: 'Sign in to join a pool',
      shareCode: '⚠️ Do not share this code publicly. Only invite trusted participants.',
      codeLabel: 'Code',
      copyCode: 'Copy code',
      copied: 'Copied!',
      copyInvitation: 'Copy full invitation',
      invitationCopied: 'Invitation copied!',
      invitationText: 'Join the {quinielaName} pool created by {creatorName} for the 2026 World Cup. Join with access code: {code}. You can also join from your mobile device or computer using the following link: {link}',
      enterGroup: 'Enter Group →',
      myGroups: 'My Pools',
      noGroups: 'No pools yet. Create one or join with a code!',
      loading: 'Loading…',
      manage: 'Manage',
      view: 'View',
      groupsTab: 'Groups',
    ...
    admin: {
      ...
      deleteDesc: 'Permanently delete this pool and all its data.',
      confirmDeleteTitle: 'Delete pool?',
      deleteWarningMembers: 'There are {n} other participant(s) who will lose their history.',
      deleteWarningPoints: 'There are predictions with already-scored points.',
      deleteIrreversible: 'This action is irreversible and cannot be undone.',
      deleting: 'Deleting…',
      closeAtPhaseLabel: 'Closing phase',
      closeAtPhaseDesc: 'Define at which phase the winner is determined. Once all matches in that phase finish, the pool is closed.',
      closeAtPhaseOptions: {
        none:  'Full (until Final)',
        r16:   'Round of 16',
        qf:    'Quarter-finals',
        sf:    'Semi-finals',
        final: 'Final',
      },
      featureExtraPointsLabel: 'Extra Points',
      extraPointsDesc: 'Enables additional predictions for Quarter-finals onwards: first scorer and match timing. Each correct pick earns +1 point.',
      extraPointsOff: 'No change',
      extraPointsOffDesc: 'Current system',
      extraPointsOn: 'Activate',
      extraPointsOnDesc: 'With Extra Points',
      featureModalTitle: 'New features for your pool!',
      featureModalSubtitle: 'Extra Points & Closing Phase',
      featureModalExtraPoints: 'from <b>Quarter-finals onwards</b>, each player can predict who scores first and in which half of the match it will happen. Every correct pick earns <b>+1 extra point</b>.',
      featureModalClosePhase: 'choose which round decides the pool winner. Once that phase ends, remaining matches are locked and the champion is announced.',
      featureModalBanner: 'When the pool closes, the <b>pool winner</b> is highlighted with a champion banner in the standings for all participants to see.',
      featureModalImportantLabel: 'Important',
      featureModalImportantBody: 'We recommend informing your participants before activating any changes, so everyone is on the same page.',
      featureModalHint: 'Remember to press <b>Save changes</b> at the bottom of settings to apply your configuration correctly.',
      featureModalLater: 'Later',
      featureModalGoSettings: 'Go to Settings',
    },
    quiniela_winner: {
      closed: 'Pool Closed',
      champion: 'Champion',
      closedPhase: {
        ...
        qf:    'Closed at QF',
        sf:    'Closed at SF',
        final: 'Closed at Final',
      },
      overlayTitle: 'Pool Closed!',
    },
    profile: {
      signInTitle: 'Sign In to Continue',
      signInDesc: 'Create an account to track your stickers and compete in pools.',
    ...
    marketplace: {
      ...
      allTeams: 'All Teams',
      special: '⭐ Special',
      searchTeam: 'Search team or code…',
      noResults: 'No results',
      filters: { All: 'All', Have: 'Have', Needed: 'Needed', Missing: 'Missing', Duplicate: 'Duplicates' },
    ...
    privacy: {
      ...
      preamble: 'At WC 2026 Hub, we take the security of your information seriously. This policy describes how we collect, use, and protect your data when you use our prediction pools and sticker album platform.',
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Prediction Privacy: Your predictions stay private until the match begins; at that point, they become visible to other members of your pool to keep the game transparent.',
