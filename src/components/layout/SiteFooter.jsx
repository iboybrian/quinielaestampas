...
export default function SiteFooter() {
  ...
  return (
    <footer className="mt-12 border-t border-white/5 bg-gradient-to-b from-slate-900 to-emerald-950/40">
      <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs">
